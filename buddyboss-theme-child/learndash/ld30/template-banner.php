        ...
        <div class="flex flex-wrap">
            <div class="bb-course-banner-inner">
				...
				<?php 
					...
					//$complexity = get_field( 'complexity_level' );
				    $complexity = get_post_meta( get_the_ID(), 'complexity_level', true );
					if( $complexity ) {
						//Concatenate the appropriate class name:
						$complexity_class = 'complexity-' . $complexity;
						echo '
							<div class="complexity-badge ' . $complexity_class . '">
								<img class="style-svg" src="https://playhacker.com/wp-content/uploads/2020/03/complexity-icon-set.svg">
							</div>';
					}
				?>
							...
							<?php foreach ( $course_cats as $course_cat ) { ?>
                                <span class="course-category-item">
                                	<a title="<?php echo $course_cat->name; ?>"
                                        href="<?php echo home_url() ?>/courses/?search=&filter-categories=<?php echo $course_cat->slug; ?>"><?php echo $course_cat->name; ?></a>
                                    <span>,
                                    </span>
                                </span>
							<?php } ?>
				...
				<?php } ?>
				<!----Time update---->
                 <span class="post-date project" >Last Updated: <?php echo do_shortcode('[last-modified format="%date%"]');?></span>
				<!------Bookmark---->
                <div class="bookmark"><?php echo do_shortcode('[favorite_button]');?></div>
