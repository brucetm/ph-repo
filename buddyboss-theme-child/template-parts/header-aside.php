		...
		<?php if ( is_user_logged_in() ) : ?>
					...
					<div class="wrapper">
						<ul class="sub-menu-inner">
							<li>
                             ...
                             <li id="boomark-menu"><a href="<?php echo home_url( '/bookmarks/' );?>" class="ab-item">Bookmarks</a></li>
                             <li id="boomark-menu"><a class="ab-item" href="<?php echo bp_loggedin_user_domain().'shop'; ?>" > Manage Shop</a></li>
            ...
            <?php else : ?>
    			...
    			<?php if( $show_messages && function_exists( 'bp_is_active' ) && bp_is_active( 'messages' )  ) : ?>
    				<?php get_template_part( 'template-parts/bookmark-dropdown' ); ?>
