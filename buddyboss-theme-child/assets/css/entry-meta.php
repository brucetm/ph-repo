...
<div class="entry-meta">
	<?php /* ?><div class="avatar-wrap">
        <a href="<?php echo $author_link; ?>">
			<?php echo get_avatar( get_the_author_meta( 'ID' ), 80 ); ?>
		</a>
	</div><?php */ ?>
	<div class="meta-wrap">
       <?php /* ?> <a class="post-author" href="<?php echo $author_link; ?>">
			<?php the_author(); ?>
		</a><?php */?>
        <?php /* <span class="post-date" >Last Updated: <a href="<?php echo esc_url( get_permalink() ); ?>"><?php echo do_shortcode('[last-modified format="%date%"]');?></a></span> */?>
        <span class="post-date" >Last Updated: <a><?php echo do_shortcode('[last-modified format="%date%"]');?></a></span>
	...
	<div class="push-right flex align-items-center top-meta">
		...
		if ( !is_single() && ( 'standard' === $blog_type || 'masonry' === $blog_type || 'grid' === $blog_type ) ) {
			...
			<?php if ( comments_open() || get_comments_number() ) { ?>
				<a href="<?php echo get_comments_link( get_the_ID() ); ?>" class="flex align-items-center">
