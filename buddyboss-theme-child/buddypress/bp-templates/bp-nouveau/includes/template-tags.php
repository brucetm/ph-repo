...
function bp_nouveau_signup_terms_privacy() {
	...
	if ( $terms && ! $privacy ) {
		?>
		<p class="register-privacy-info ph1">
			<?php printf( __( 'By creating an account you are agreeing to our <a class="popup-modal-register popup-terms" href="#terms-modal">%s</a>.', 'buddyboss' ), get_the_title( $terms ) ); ?>
		</p>
	...
	if ( ! $terms && $privacy ) {
		?>
        <p class="register-privacy-info ph2">
            <?php printf( __( 'By creating an account you are agreeing to our <a class="popup-modal-register popup-privacy" href="#privacy-modal">%s</a>.', 'buddyboss' ), get_the_title( $privacy ) ); ?>
        </p>
	...
	if ( $terms && $privacy ) {
		?>
        <p class="register-privacy-info ph">
            <?php printf( __( 'By creating an account you are agreeing to our <a class="popup-modal-register popup-terms" href="#terms-modal">%s</a> and <a class="popup-modal-register popup-privacy" href="#privacy-modal">%s</a>.', 'buddyboss' ), get_the_title( $terms ), get_the_title( $privacy ) ); ?>
        </p>
		<div id="terms-modal" class="mfp-hide registration-popup bb-modal">
			<h1><?php echo esc_html( get_the_title( $terms ) ); ?></h1>
			<?php
