...
require_once $_SERVER['DOCUMENT_ROOT'].'wp-content/plugins/votes/app/Entities/PostType/PostTypeRepository.php';
/**
* Add Post Vote Counts to Admin Columns
*/
class AdminColumns
{
	/**
	...
	*/
	...
	{
		$new_column = ['votes' => __('Votes', 'votes')];
